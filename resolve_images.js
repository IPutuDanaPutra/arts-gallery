...
const artworkData = [
    ...
    { id: 44, title: "The Fighting Temeraire", artist: "J.M.W. Turner", year: "1839", search: "The Fighting Temeraire tugged to her last berth to be broken up, 1839.jpg" },
...
async function fetchUrl(titleStr) {
    const options = {
        headers: {
            'User-Agent': 'GalleryAppCorrectionBot/1.0 (contact@example.com)'
        }
    };
...
(async () => {
    ...
    for (const item of artworkData) {
        ...
        if (url) {
            ...
            url = "https://placehold.co/600x800?text=Image+Not+Found";
        }
    ...
    fs.writeFileSync('resolved_artworks.json', JSON.stringify(resolved, null, 2));
    console.log("Done.");
})();
